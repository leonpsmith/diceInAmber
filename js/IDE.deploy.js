...
fn: function () {
    ...
    return ($receiver = self['@selectedClass']) == nil ||
        $receiver == undefined ? function () {return unescape("Browser%20%28nil%29");}() : function () {return smalltalk.send("Browser: ", "__comma", [smalltalk.send(self['@selectedClass'], "_name", [])]);}();
    return self;
}
}),
smalltalk.Browser);
...
fn: function () {
    ...
    try {
        ...
        ($receiver = self['@selectedClass']) == nil ||
            $receiver == undefined ? function () {return function () {throw {name: "stReturn", selector: "_classDeclarationSource", fn: function () {return smalltalk.send(self, "_classDeclarationTemplate", []);}};}();}() : $receiver;
        ...
        if (e.name === "stReturn" &&
            e.selector === "_classDeclarationSource") {
            return e.fn();
        }
        throw e;
    }
...
fn: function (aTextarea) {
    var self = this;
    self['@editor'] = CodeMirror.fromTextArea(aTextarea, {theme: "jtalk", lineNumbers: true, enterMode: "flat", matchBrackets: true, electricChars: false});
    return self;
}
}),
smalltalk.SourceArea);
...
fn: function () {
    ...
    return ($receiver = smalltalk.send(self, "_method", [])) == nil ||
        $receiver == undefined ? function () {return unescape("Method%20doesn%27t%20exist%21");}() : function () {return smalltalk.send(smalltalk.send(self, "_method", []), "_source", []);}();
    return self;
}
}),
smalltalk.Debugger);
